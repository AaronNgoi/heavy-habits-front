import { startOfWeek, endOfWeek, startOfDay, addDays, format, parse, eachDayOfInterval, compareAsc } from 'date-fns';
import { getCurrentDateInUserTimezoneDateFormat } from '../utils/dateUtils';

const recalculateHistoricalWeeklyExpectedDates = (habit, addedHistoricalRecordDate) => {
    ...
    const startOfWeekDate = startOfWeek(addedHistoricalRecordDate, {weekStartsOn: 1}); // Monday
    const endOfWeekDate = endOfWeek(addedHistoricalRecordDate, {weekStartsOn: 1}); // Sunday
...
export default recalculateHistoricalWeeklyExpectedDates;